...
<div class="landing-version">
    <div class="container">
        <div class="col-md-6">
            ...
            <h2>DARK VERSION</h2>
            <a href="index.jsp" target="blank_" class="redbtn">SEE DEMO</a>
        </div>
        <div class="col-md-6">
            <img src="images/uploads/landing-light-version.png" alt="Light Version">
            <h2>LIGHT VERSION</h2>
            <a href="index_light.jsp" target="blank_" class="redbtn">SEE DEMO</a>
        </div>
    </div>
</div>
<!-- footer v3 section-->
<div class="ft-copyright-landing">
    <p>© 2017 Blockbuster. All Rights <a href="http://www.bootstrapmb.com/" title="bootstrapmb">Reserved</a>. Designed by haintheme.</p>
</div>
