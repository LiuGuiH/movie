    ...
    <div class="login-content">
        ...
        <form method="post" action="signup">
            ...
            <div class="row">
                <label for="email-2">
                    your email:
                    <input type="email" name="email" id="email-2" placeholder="***@***.com" required="required" />
                </label>
            </div>
            <div class="row">
                <label for="password-2">
                    Password:
                    <input type="password" name="password" id="password-2" placeholder=""  pattern="^[a-zA-Z0-9-_\.]{6,16}$" required="required" />
                </label>
            </div>
            <div class="row">
                <label for="repassword-2">
                    re-type Password:
                    <input type="password" name="password" id="repassword-2" placeholder=""  pattern="^[a-zA-Z0-9-_\.]{6,16}$" required="required" />
                </label>
            </div>
            <div class="row">
