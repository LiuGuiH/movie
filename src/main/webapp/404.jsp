    ...
    <div class="login-content">
        ...
        <form method="post" action="login.php">
            <div class="row">
                <label for="username">
                    用户:
                    <input type="text" name="username" id="username" placeholder="HughJackman" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{8,20}$" required="required" />
                </label>
            </div>
            ...
            <div class="row">
                <label for="password">
                    密码:
                    <input type="password" name="password" id="password" placeholder="******" pattern="^[a-zA-Z][.]{5-15}$" required="required" />
                </label>
            </div>
            <div class="row">
                <div class="remember">
