        ...
        <div class="row ipad-width2">
            <div class="col-md-9 col-sm-12 col-xs-12">
                <div class="topbar-filter">
                    ...
                    <a  href="celebritygrid02.jsp" class="grid"><i class="ion-grid active"></i></a>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="ceb-item-style-2">
                            ...
                            <div class="ceb-infor">
                                <h2><a href="celebritysingle.jsp">Leonardo DiCaprio</a></h2>
                                <span>actor, uk</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="ceb-item-style-2">
                            ...
                            <div class="ceb-infor">
                                <h2><a href="celebritysingle.jsp">Meryl Streep</a></h2>
                    ...
                    <div class="col-md-4">
                        <div class="ceb-item-style-2">
                            ...
                            <div class="ceb-infor">
                                <h2><a href="celebritysingle.jsp">Tom Hanks</a></h2>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="ceb-item-style-2">
                            ...
                            <div class="ceb-infor">
                                <h2><a href="celebritysingle.jsp">Robert De Niro</a></h2>
                                <span>actor, uk</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="ceb-item-style-2">
                            ...
                            <div class="ceb-infor">
                                <h2><a href="celebritysingle.jsp">Kamal Haasan</a></h2>
                    ...
                    <div class="col-md-4">
                        <div class="ceb-item-style-2">
                            ...
                            <div class="ceb-infor">
                                <h2><a href="celebritysingle.jsp">Anthony Hopkins</a></h2>
