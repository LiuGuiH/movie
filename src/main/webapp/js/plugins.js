...
;(function(factory) {
    ...
    Slick.prototype.changeSlide = function(event, dontAnimate) {
        ...
        switch (event.data.message) {
            ...
            case 'index1.html':
                var index = event.data.index1 === 0 ? 0 :
                    event.data.index1 || $target.index() * _.options.slidesToScroll;
