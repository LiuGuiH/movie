        ...
        <div class="row ipad-width2">
            ...
            <div class="col-md-8 col-sm-12 col-xs-12">
                <div class="movie-single-ct main-content">
                    <h1 class="bd-hd">${movie.moviename}</h1>
                    <div class="social-btn">
                        <a id="heart" class="parent-btn">
                            <c:if test="${movieStatus==null}">
                    ...
                    <div class="movie-rate">
                        ...
                        <div class="rate-star">
                            <p>Rate This Movie:  </p>
                            <c:forEach begin="1" end="${ms}">
                                <i class="ion-ios-star"></i>
                            </c:forEach>
                            <c:forEach end="${10-ms}" begin="1">
                                ...
                                <div id="reviews" class="tab review">
                                    <div class="row" id="comment-append">
                                        ...
                                        <div class="topbar-filter">
                                            <p>Found <span>${movieComments.size()} reviews</span> in total</p>
                                        </div>
                                        <c:forEach items="${movieComments}" var="movieComment" varStatus="index">
                                            <div class="mv-user-review-item">
                                                <div class="user-infor">
                                                    <img src="images/uploads/userava1.jpg" alt="">
                                                    <div id="stars">
                                                        <h3>${movieComment.commenttitle}</h3>
                                                        <div class="no-star">
                                                            <c:forEach begin="1" end="${movieComment.commentstar}">
                                                                <i class="ion-ios-star"></i>
                                                            </c:forEach>
                                                            <c:forEach end="${10-movieComment.commentstar}" begin="1">
                                                                <i class="ion-ios-star-outline"></i>
                                                            </c:forEach>
                                                        </div>
                                                        <p class="time">
                                                            ${movieComment.commenttime} by <a href=""> ${usernames.get(index.index)}</a>
                                                        </p>
                                                    </div>
                                                </div>
                                                <p>${movieComment.commentcontent}</p>
                                            </div>
                                        </c:forEach>
    ...
    $(function () {
        ...
        $("#review").click(function () {
            ...
            $.ajax({
                type:"GET",
                url:"movieComment",
                data:{"title":title,"star0":star,"content":content,"userid":"${user.userid}","movieid":"${movie.movieid}"},
                datatype:"json",
        ...
        $("#heart").click(function () {
            ...
            if ("ion-ios-heart"==className){
                ...
                if (flag==true){
                    ...
                    $.ajax({
                        type:"GET",
                        url:"deleteFavoriteByMovieId",
                        data:{"movieid":${movie.movieid},"userid":${user.userid}},
                        datatype:"json",
                        success:function (result) {
                            console.log(result)
                        }
